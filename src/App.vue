          ...
          datasets: [
            {
              ...
              .sort((a, b)=> a.date - b.date)
              .map(weight => weight.weight),
              backgroundColor: 'rgba(80,120,250,0.3)',
              borderColor: 'rgba(80, 120, 250,1)',
              borderWidth:1,
              fill: true
            }
          ]
...
<template>
    <main>
      ...
      <form @submit.prevent="addWeight">
          <input type="number" step="0.1" v-model="weightInput" placeholder="Enter weight in kg" />
          <input type="submit" value="Add Weight" />
      </form>
      <div class="output" v-if="weights && weights.length >0">
          <h2>Last 7 days</h2>
